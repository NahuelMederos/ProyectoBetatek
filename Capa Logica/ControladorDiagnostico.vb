...
Public Module ControladorDiagnostico
    ...
    Public Sub CrearDiagnostico(Sintomas As String, Patologias As String, Usuario As String, Prioridad As String, SolicitaChat As String)
        ...
        Dim Informacion As String = "El paciente " + Usuario + " solicito un diagnostico presentando los siguientes sintomas: " + Sintomas + Environment.NewLine + "El Diagnostico automatico le dio como resultado:" + Patologias
